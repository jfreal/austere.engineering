<template>
  <div>
    ...
    <footer
      class="text-center lg:text-left bg-lighttan border-tan border-t mt-12"
    >
      ...
      <div class="text-center p-6 bg-lighttan">
        <span>© 2021 Copyright:</span>
        <a class="font-semibold" href="https://austere.engineering/"
          >Austere Engineering</a
        >
      </div>
    </footer>
  </div>
